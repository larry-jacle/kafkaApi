...
public class KTableJoin {
    ...
    public static void main(String[] args) {
        ...
        //设置流的配置参数
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "kafka-stream-tableJoin");
        ...
        KTable<String,String>  source1=streamsBuilder.table("joinA");
        KTable<String,String>  source2=streamsBuilder.table("joinB");
        KTable<String,String>  all=source1.join(source2,(s1,s2)->s1+"--"+s2);
        all.toStream().print(Printed.toSysOut());
